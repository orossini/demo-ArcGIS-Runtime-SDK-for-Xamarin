...
public class AndroidDeviceInteractionHandler
	extends md5bbfa0ee849683f03e23f9abdeac5453a.UserInteractionHandler
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.0.0.0, Culture=neutral, PublicKeyToken=29c6dd6e8553d944", AndroidDeviceInteractionHandler.class, __md_methods);
	}
	...
	public AndroidDeviceInteractionHandler () throws java.lang.Throwable
	{
		...
		if (getClass () == AndroidDeviceInteractionHandler.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.UI.AndroidDeviceInteractionHandler, Esri.ArcGISRuntime, Version=100.0.0.0, Culture=neutral, PublicKeyToken=29c6dd6e8553d944", "", this, new java.lang.Object[] {  });
	}

	public AndroidDeviceInteractionHandler (md5bbfa0ee849683f03e23f9abdeac5453a.GeoView p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == AndroidDeviceInteractionHandler.class)
